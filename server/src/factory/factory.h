...
public:
  static std::shared_ptr<LibArchiveCompressor>
  createCompressor(CompressionFormat format);
  ...
  static CompressionFormat detectFormatFromData(const std::vector<uint8_t> &data);
};
